...
function App() {
  ...
  const projects = [
    ...
    },
    {
      title: "Task Maker",
      description:
        "Task tracker application uses to track daily tasks with timestamp enabled",
      image:
        "https://res.cloudinary.com/krishnamohan479/image/upload/v1738611630/taskTracker-green_etiwj1.png",
  ...
  return (
    ...
    >
      {/* <SplashCursor className="hidden lg:block" /> */}

      <Background darkMode={darkMode} />
      <Navbar darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
      {console.log(
        "%cHello, This is Krishna Mohan, Thanks for visiting my Portfolio",
        "color: blue; font-weight: bold; font-size: 20px; background: yellow; padding: 5px;"
      )}
      {/* Hero Section */}
      <section
        id="home"
        className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-2 overflow-hidden"
      >
        ...
        <animated.div
          style={fadeIn}
          className="w-full max-w-7xl mx-auto text-center p-auto z-10"
        >
          <div className="space-y-4 sm:space-y-6 px-4">
            ...
            <img
              src="https://res.cloudinary.com/krishnamohan479/image/upload/v1738570016/11zon_cropped_ylxkpq.jpg"
              alt="Krishna Mohan"
            ...
            <p
              className={`text-base sm:text-lg md:text-xl mb-8 sm:mb-12 max-w-2xl mx-auto ${
